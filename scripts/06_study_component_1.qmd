...
fixef(h11_rs)
# ranef(h11_rs)
intervals(h11_rs, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h11_rs)
```
...
summary(h11_time)
# ranef(h11_time)
intervals(h11_time, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h11_time)
```
...
summary(h11_elevation)
intervals(h11_elevation, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h11_elevation)
...
summary(h11_5)
# ranef(h11)
intervals(h11_5, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h11_5)
```
...
plot_hist_numeric(esm_data_5, "love", "Ditribution of Outcome Variable 'love'", "love (0-100)",2)
...
summary(h11_10)
# ranef(h11)
intervals(h11_10, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h11_10)
...
plot_hist_numeric(esm_data_10, "love", "Ditribution of Outcome Variable 'love'", "love (0-100)",2)
...
summary(h11_20)
# ranef(h11)
intervals(h11_20, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h11_20)
...
plot_hist_numeric(esm_data_20, "love", "Ditribution of Outcome Variable 'love'", "love (0-100)",2)
...
fixef(h13_PA_rs)
# ranef(h11_rs)
intervals(h13_PA_rs, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h13_PA_rs)
...
summary(h13_PA_elevation)
intervals(h13_PA_elevation, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h13_PA_elevation)
```
...
fixef(h13_NA_rs)
# ranef(h11_rs)
intervals(h13_NA_rs, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h13_NA_rs)
...
summary(h13_NA_elevation)
intervals(h13_NA_elevation, which = "fixed")  # 95% CIs for fixed effects
VarCorr(h13_NA_elevation)
```
