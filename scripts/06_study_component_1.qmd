...
resid_fitted_plot <- ggplot(diag_data, aes(x = .fitted, y = .resid_norm)) +
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_h11_residuals_vs_fitted.png", prefix, plot_counter)),
  plot = resid_fitted_plot + labs(title = NULL, subtitle = NULL),
...
# residuals by dyad
resid_dyad_plot <- ggplot(diag_data, aes(x = factor(dyad), y = .resid_norm)) +
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_h11_residuals_by_dyad.png", prefix, plot_counter)),
  plot = resid_dyad_plot + labs(title = NULL, subtitle = NULL),
  width = 7, height = 5, dpi = 300
)
plot_counter <- plot_counter + 1
resid_dyad_plot
...
# residuals vs time
resid_time_plot <- ggplot(diag_data, aes(x = time, y = .resid_norm)) +
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_h11_residuals_vs_time.png", prefix, plot_counter)),
  plot = resid_time_plot + labs(title = NULL, subtitle = NULL),
  width = 7, height = 5, dpi = 300
)
plot_counter <- plot_counter + 1
resid_time_plot
...
png(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_h11_residuals_qq_plot.png", prefix, plot_counter)),
  width = 7, height = 5, units = "in", res = 300
)
qqnorm(diag_data$.resid_norm, main = "")
qqline(diag_data$.resid_norm, lwd = 2)
invisible(dev.off())
plot_counter <- plot_counter + 1
```
...
png(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_h11_remaining_autocorrelation.png", prefix, plot_counter)),
  width = 7, height = 5, units = "in", res = 300
)
plot(ACF(h11, resType = "normalized", maxLag = 10), 
     alpha = 0.05, 
...
png(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_h11_fit_vs_data_mixed_effect_bounds.png", prefix, plot_counter)),
  width = 7, height = 5, units = "in", res = 300
)
plot(pred_cond, pch = 16,
     ylab = "Mixed effect (fixed + random effects) predicitions of love",
...
png(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_h11_fit_vs_data_fixed_effect_bounds.png", prefix, plot_counter)),
  width = 7, height = 5, units = "in", res = 300
)
plot(pred_fixed, pch = 16,
     ylab = "Fixed effect predictions of love",
...
obs_pred_plot <- ggplot(diag_plot, aes(x = pred, y = love)) +
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_h11_fit_vs_data_observed_vs_predicted.png", prefix, plot_counter)),
  plot = obs_pred_plot + labs(title = NULL, subtitle = NULL),
  width = 7, height = 5, dpi = 300
)
plot_counter <- plot_counter + 1
obs_pred_plot
...
med_plot <- plot(p) + ggtitle("General Mediation Diagram")
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_mediation_general_diagram.png", prefix, plot_counter)),
  plot = med_plot, width = 7, height = 5, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
```
...
med_plot <- plot(p) + ggtitle("Within Person Mediation Diagram: PA")
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_mediation_within_person_PA.png", prefix, plot_counter)),
  plot = med_plot, width = 7, height = 5, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
med_plot <- plot(p) + ggtitle("Between Person Mediation Diagram: PA")
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_mediation_between_person_PA.png", prefix, plot_counter)),
  plot = med_plot, width = 7, height = 5, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
med_plot <- plot(p) + ggtitle("Within Person Mediation Diagram: NA")
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_mediation_within_person_NA.png", prefix, plot_counter)),
  plot = med_plot, width = 7, height = 5, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
med_plot <- plot(p) + ggtitle("Between Person Mediation Diagram: NA")
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_mediation_between_person_NA.png", prefix, plot_counter)),
  plot = med_plot, width = 7, height = 5, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
$$\begin{aligned}
L_{mpd} =\ & b_{0,pd} + \beta_1 S^{act,within}_{mpd} + \beta_2 \bar{S}^{act,between}_d \\
& + \beta_3 R_{mpd} + \beta_4 (S^{act,within}_{mpd} \times R_{mpd}) \\
& + \varepsilon_{mpd}
\end{aligned}$$
...
$$\begin{aligned}
L_{mpd} &= f_{0,pd} + \phi_1 S_{mpd}^{\text{perc,within}} \\
&\quad + \phi_2 \bar{S}_d^{\text{perc,between}} + \phi_3 S_{mpd}^{\text{act,within}} \\
&\quad + \phi_4 \bar{S}_d^{\text{act,between}} + \phi_5 R_{mpd} \\
&\quad + \phi_6 \left(S_{mpd}^{\text{perc,within}} \times R_{mpd}\right) \\
&\quad + \phi_7 \left(S_{mpd}^{\text{act,within}} \times R_{mpd}\right) + \varepsilon_{mpd}
\end{aligned}$$
...
+ \theta_3\, R_{mpd}
+ \theta_4 \left(S_{mpd}^{act,within} \times R_{mpd}\right)
+ \varepsilon_{mpd}$$
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_responsiveness_PA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
```
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_responsiveness_NA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
& + \beta_3 C_{mpd} + \beta_4(S_{mpd}^{act,within} \times C_{mpd}) \\
& + \varepsilon_{mpd}
\end{aligned}$$
...
& + \beta_3 C_{mpd} + \beta_4(S_{mpd}^{perc,within} \times C_{mpd}) \\
& + \varepsilon_{mpd}
\end{aligned}$$
...
&\quad + \phi_3 S_{mpd}^{act,within} + \phi_4 \bar{S}_d^{act,between} + \phi_5 C_{mpd} \\
&\quad + \phi_6 (S_{mpd}^{perc,within} \times C_{mpd}) \\
&\quad + \phi_7 (S_{mpd}^{act,within} \times C_{mpd}) \\
&\quad + \varepsilon_{mpd}
\end{aligned}$$
...
$$S_{mpd}^{perc} = t_{0,pd} + \theta_1 S_{mpd}^{act,within} + \theta_2 \bar{S}_d^{act,between}
+ \theta_3\, C_{mpd}
+ \theta_4 \left(S_{mpd}^{act,within} \times C_{mpd}\right)
+ \varepsilon_{mpd}$$
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_event_valence_PA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
plot(p_mod) +
  ...
  labs(caption = "Dashed arrow indicates moderation of the a-path (Hayes, 2013 convention). b-path, c\u2019-path, and their moderation by event valence all non-significant.") -> med_plot
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_event_valence_NA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
$$C^{expl}_{mpd} = \begin{cases}
  \mathrm{pos\_part}_{mpd} - \mathrm{neg\_part}_{mpd} & \text{if partner-item branch was taken}\\
  \mathrm{pos\_gen}_{mpd} - \mathrm{neg\_gen}_{mpd} & \text{if general-item branch taken (partner items NA)}
\end{cases}$$
...
kable(tbl_e1_h33a,
  ...
  kableExtra::footnote(general = "Simple slopes estimated at −1 SD, mean, and +1 SD of cC_expl. Degrees of freedom estimated via Satterthwaite approximation.",
...
# make_rows_expl() is defined in R/04_functions.R
tbl_e1_out <- rbind(
...
plot(p_mod) +
  ...
  labs(caption = "Dashed arrows indicate moderation of the a-path (\u03B84) and c\u2019-path (\u03C67). b-path moderation non-significant.") -> med_plot
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_extended_valence_PA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
plot(p_mod) +
  ...
  labs(caption = "Dashed arrows indicate moderation of the a-path (\u03B84), b-path (\u03C66), and c\u2019-path (\u03C67).") -> med_plot
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_extended_valence_NA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
$$D^{neg}_{mpd} = \begin{cases}
  1 & \text{if } \mathrm{neg\_gen}_{mpd} \geq 2 \;\text{or}\; \mathrm{neg\_part}_{mpd} \geq 2 \\
  0 & \text{otherwise}
\end{cases}$$

where 1 indicates that something negative happened (even if only a little) and 0 that nothing negative happened.
...
kable(tbl_e2_h33a,
  ...
  kable_styling(bootstrap_options = c("striped", "hover"),
                full_width = FALSE, position = "left") %>%
  kableExtra::footnote(general = "Simple slopes estimated at D_neg = 0 (no negative event) and D_neg = 1 (negative event occurred). Degrees of freedom estimated via Satterthwaite approximation.",
           general_title = "Note.", footnote_as_chunk = TRUE)
```
...
# make_rows_dummy() is defined in R/04_functions.R
tbl_e2_out <- rbind(
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_neg_event_PA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_neg_event_NA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
$$D^{pos}_{mpd} = \begin{cases}
  1 & \text{if } \mathrm{pos\_gen}_{mpd} \geq 2 \;\text{or}\; \mathrm{pos\_part}_{mpd} \geq 2 \\
  0 & \text{otherwise}
\end{cases}$$

where 1 indicates that something positive happened (even if only a little) and 0 that nothing positive happened.
...
kable(tbl_e3_h33a,
  ...
  kable_styling(bootstrap_options = c("striped", "hover"),
                full_width = FALSE, position = "left") %>%
  kableExtra::footnote(general = "Simple slopes estimated at D_pos = 0 (no positive event) and D_pos = 1 (positive event occurred). Degrees of freedom estimated via Satterthwaite approximation.",
           general_title = "Note.", footnote_as_chunk = TRUE)
```
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_pos_event_PA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
...
ggsave(
  filename = file.path(dir_plots,
                       sprintf("%s_%02d_moderated_mediation_pos_event_NA.png", prefix, plot_counter)),
  plot = med_plot, width = 9, height = 7, dpi = 300
)
plot_counter <- plot_counter + 1
med_plot
