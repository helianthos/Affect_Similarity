...
The moderated mediator model tests whether $cC^{expl}_{mpd}$ moderates the a-path:
...
make_rows_pos <- function(df, trend_col, predictor_label) {
  data.frame(
    `Predictor`      = predictor_label,
    `Positive event` = c("No (0)", "Yes (1)"),
    `Simple slope`   = sprintf("%.4f", df[[trend_col]]),
...
tbl_e3_out <- rbind(
  make_rows_pos(e3_slopes_out_act_df,  "PA_similarity_act_w.trend",
                "Actual PA similarity"),
  make_rows_pos(e3_slopes_out_perc_df, "PA_similarity_perc_w.trend",
                "Perceived PA similarity")
)
...
tbl_e3_out_na <- rbind(
  make_rows_pos(e3_slopes_out_na_act_df,  "NA_similarity_act_w.trend",
                "Actual NA similarity"),
  make_rows_pos(e3_slopes_out_na_perc_df, "NA_similarity_perc_w.trend",
                "Perceived NA similarity")
)
