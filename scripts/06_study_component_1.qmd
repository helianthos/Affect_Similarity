...
plot(p_mod) +
  ...
  annotate("text",
    x = w1_x, y = w1_y + 0.15,
    label = "Perceived\nResponsiveness",
    hjust = 0.5, fontface = "plain", colour = "grey60"
  ) +
